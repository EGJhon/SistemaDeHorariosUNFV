...
// Bloques de Horas Académicas UNFV (1 Hora Académica = 50 min)
// Bloques comunes de 2 Horas Académicas = 100 minutos (ej. 08:00-09:40)
const UNFV_SLOTS = [
...
// Compute how many 50-min academic slots a block spans
  ...
  return (
    <div className="timetable-container">
      <div className="timetable-grid" style={{ gridTemplateColumns: '150px repeat(6, 1fr)' }}>
        ...
        {/* Time Rows (UNFV 50-minute academic slots) */}
        {UNFV_SLOTS.map((slot) => (
